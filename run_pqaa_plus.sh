...
python ./run_pubmedqa.py --model_name_or_path $BIOBERT_DIR --task_name=$TASK_NAME --do_train --do_eval  --max_seq_length=512 --data_dir $RE_DIR --per_gpu_eval_batch_size=8 --per_gpu_train_batch_size=8 --learning_rate=2e-5 --num_train_epochs=5.0 --do_lower_case=false --output_dir=$OUTPUT_DIR --overwrite_output_dir --save_steps 25000 --evaluate_during_training
